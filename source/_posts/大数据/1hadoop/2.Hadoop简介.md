...
![hadoop生态圈](/images/大数据/1hadoop/2hadoop/1hadoop生态圈.png)

# Hadoop 发展历史

为了实现与Google类似的全文搜索功能，Hadoop创始人Doug Cutting在Lucene框架基础上进行优化升级，查询引擎和索引引擎，名字来源于儿子的玩具大象 。

![2doug-cutting.png](/images/大数据/1hadoop/2hadoop/2doug-cutting.png)
...
![3hadoop.png](/images/大数据/1hadoop/2hadoop/3hadoop.png)
...
![4hadoop的组成.png](/images/大数据/1hadoop/2hadoop/4hadoop的组成.png)
...
![5yarn架构概述.png](/images/大数据/1hadoop/2hadoop/5yarn架构概述.png)
...
![6mapreduce.png](/images/大数据/1hadoop/2hadoop/6mapreduce.png)

## HDFS、YARN、MapReduce三者关系

![7三者关系图](/images/大数据/1hadoop/2hadoop/7三者关系图.png)
